 ...
 */
public class DeleteEdgeMenuItem<MyEdge> extends JMenuItem implements EdgeMenuListener<MyEdge> {
    /**
	 * 
	 */
     ...
     * @param visComp 
     */
    public void setEdgeAndView(MyEdge edge, VisualizationViewer<DeusVertex, MyEdge> visComp) {
        this.edge = edge;
