...
public class RevolBAConnectionEvent extends Event {
	...
	public RevolBAConnectionEvent(String id, Properties params, Process parentProcess)
	...
	public Object clone() {
		RevolBAConnectionEvent clone = (RevolBAConnectionEvent) super.clone();
		clone.initiator = null;
		clone.target = null;
		return clone;
	}

	// TODO il numero di vicini iniziali deve essere un parametro, e poi devo implementare BA 
