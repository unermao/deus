 ...
 * 
 */
public class LogStreamingPeerStatsEvent extends Event {

	public LogStreamingPeerStatsEvent(String id, Properties params,
	...
	public void run() throws RunException {
		...
		for (Iterator<Node> it = Engine.getDefault().getNodes().iterator(); it
			...
			initialStreamingTot += currentNode.getMaxPower();
			StreamingTot += currentNode.getPower();
		}
		...
		getLogger().info(
				"mean max POWER value: " + (double) initialStreamingTot / numNodes);
		getLogger().info("mean POWER value: " + (double) StreamingTot / numNodes);
	}
