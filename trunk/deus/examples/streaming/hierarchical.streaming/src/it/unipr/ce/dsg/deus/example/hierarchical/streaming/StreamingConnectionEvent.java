...
public class StreamingConnectionEvent extends NodeEvent {
	...
	public void run() throws RunException {
		...
		//Se il numero di peer presenti nel sistema (per il mio livello) � maggiore alla dimensione max della lista vicini per il livello 
		...
		{	
			...
			while( cont < associatedStreamingNode.getMaxPartnersNumber() )
			{
				...
				//Se � connesso, e nn ce l'ho gi� e nn sono io allora lo aggiungo alla lista dei vicini
				if(		peer.isConnected() 
