...
//		if(this.getKey()==497109061){
//   		this.printVideoBuffer(this.player);
...
//		if(0.648/this.k_value > this.getServerByPeer().get(i).getUploadSpeed()/this.getServerByPeer().get(i).getActiveConnection()
