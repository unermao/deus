 ...
 * 
 */
public class EnergylDiscoveryEvent extends NodeEvent {
	...
	public EnergylDiscoveryEvent(String id, Properties params,
	...
	public Object clone() {
		EnergylDiscoveryEvent clone = (EnergylDiscoveryEvent) super.clone();
	...
	public boolean isResourceAdvInCache(EnergyPeer associatedRevolNode) {
		...
		if (resFound == true) {
			...
			EnergylDiscoveryEvent discEv = (EnergylDiscoveryEvent) Engine
					.getDefault().createEvent(
							EnergylDiscoveryEvent.class,
							triggeringTime
									+ expRandom(meanArrivalTriggeredDiscovery));
