...
import edu.uci.ics.jung.visualization.VisualizationViewer;
	 ...
	 * 
	 */
public class ToolbarDeus extends JToolBar implements ActionListener, SetVisualizationView{
	...
	public ToolbarDeus(){
        ...
        JToolBar.Separator separator = new JToolBar.Separator(new Dimension(15,5));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand()=="savexml"){
			...
			Set<DeusVertex> vertSelectedSet = visView.getPickedVertexState().getPicked();
