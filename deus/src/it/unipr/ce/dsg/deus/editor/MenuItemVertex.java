...
/**
 * A class that add a menu to all vertices and run the window dialog to set attribute
...
public class MenuItemVertex extends JPopupMenu{
	...
	public class goPopup extends JMenuItem implements VertexMenuListener<DeusVertex> {
		/**
		 * 
		 */
		...
		@Override
		public void setVertexAndView(DeusVertex vertex, VisualizationViewer<DeusVertex, DeusEdge> visComp) {
        ...
        this.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				VertexPropertiesDialog createDialog = new VertexPropertiesDialog(frame, vertex);
				createDialog.setLocationRelativeTo(frame);
				createDialog.setVisible(true);
				//aggiorno il label del vertice
				visComp.repaint();
