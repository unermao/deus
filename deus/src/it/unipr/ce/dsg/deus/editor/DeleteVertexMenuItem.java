 ...
 */
public class DeleteVertexMenuItem<MyVertex> extends JMenuItem implements VertexMenuListener<MyVertex> {
    /**
	 * 
	 */
     ...
     * @param visComp 
     */
    public void setVertexAndView(MyVertex v, VisualizationViewer<MyVertex, DeusEdge> visComp) {
        this.vertex = v;
