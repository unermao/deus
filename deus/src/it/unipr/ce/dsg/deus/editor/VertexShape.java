...
/**
 * A class that draws a figure in relation to the 
 * type of the vertex
...
implements Transformer<DeusVertex,Shape> {
	...
	VertexShape(){
		...
		//aumento la dimensione del vertex rispetto a quella di default 
	...
	//trasforma la figura in un quadrato
	public Shape transform(DeusVertex v)
	{
		...
		else return factory.getRegularPolygon(v, 8);
