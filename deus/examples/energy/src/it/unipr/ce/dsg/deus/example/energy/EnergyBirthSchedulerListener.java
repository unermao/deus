 ...
 *
 */
public class EnergyBirthSchedulerListener implements SchedulerListener {
	...
	public void newEventScheduled(Event parentEvent, Event newEvent) {
		...
		} else if (newEvent instanceof EnergyDiscoveryEvent) {
			((EnergyDiscoveryEvent) newEvent).setAssociatedNode((EnergyPeer) be.getAssociatedNode());
		}
	}
